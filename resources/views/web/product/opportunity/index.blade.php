...
@section('body')
    <img src="/images/opportunity/top1.png?imageslim" onclick="return false;" />
    <div class="main luckYear">
        <img src="/images/opportunity/top2.png?imageslim" onclick="return false;"/>
        <div class="words">
            <img src="/images/purple/top3.png?imageslim" onclick="return false;"/>
            <div class="words-title text-center">马上测算何时转运</div>
        </div>
        ...
        <img class="marginT20" src="/images/opportunity/top3.png?imageslim" onclick="return false;"/>
        <img class="marginT20" src="/images/opportunity/top4.png?imageslim" onclick="return false;"/>
        <img class="marginT40" src="/images/opportunity/top5.png?imageslim" onclick="return false;"/>
        ...
        <div class="score marginT20 luckYear-area luckYear-score">
            ...
            <p class="yx">
                ...
                <span class="area bg_color3">改变命运</span>
            </p>
        </div>
        ...
        <div class="comment marginT20 luckYear-area luckYear-comment">
            <ul>
                ...
                <li>
                    ...
                    这是综合分析，看完还是很震撼的！之前不是很理解为什么要算这些，现在终于明白，这是大自然规律，每个人出生也一样，受时间支配，然后形成的性格和运势的变化
                </li>
                <li>
