...
@section('body')
    <img src="/images/fiveCharacter/top1.png?imageslim" onclick="return false;" />
    <div class="main luckYear">
        <img src="/images/fiveCharacter/top2.png?imageslim" onclick="return false;"/>
        <div class="words">
            <img src="/images/purple/top3.png?imageslim" onclick="return false;"/>
            <div class="words-title text-center">立即揭晓五行命运</div>
        </div>
        ...
        <div class="number text-center marginT20">已有&nbsp;<span>233450</span>&nbsp;人分析五行命盘</div>

        <img class="marginT20" src="/images/fiveCharacter/top3.png?imageslim" onclick="return false;"/>
        <img class="marginT20" src="/images/fiveCharacter/top4.png?imageslim" onclick="return false;"/>
        <img class="marginT40" src="/images/fiveCharacter/top5.png?imageslim" onclick="return false;"/>
        ...
        <div class="score marginT20 luckYear-area luckYear-score">
            ...
            <p class="yx">
                ...
                <span class="area bg_color2">说的不错</span>
        ...
        <div class="comment marginT20 luckYear-area luckYear-comment">
            <ul>
                ...
                <li>
                    ...
                    这是综合分析一个人五行命盘，看完还是很震撼的！之前不是很理解为什么要算这些，现在终于明白，这是大自然规律，每个人出生也一样，受时间支配，然后形成的性格和运势的变化
                </li>
                <li>
